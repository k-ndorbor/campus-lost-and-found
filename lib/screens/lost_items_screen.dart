...
class LostItemsScreen extends StatelessWidget {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          constraints: const BoxConstraints(),
                          onPressed: () async {
                            await _startConversation(context, item, docId);
                          },
  ...
  Future<void> _startConversation(
      BuildContext context, Item item, String docId) async {
    try {
      ...
      try {
        ...
        if (userDoc.exists) {
          ...
          otherUserName = userData['name'] ?? userData['displayName'] ?? 'User';
        }
      } catch (e) {
        // If we can't fetch the user's name, fall back to contact or default
        otherUserName = item.contact.isNotEmpty ? item.contact : 'User';
      }
